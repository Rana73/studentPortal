                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="username" value="{{ $user->username }}" autocomplete="off"
                                            class="form-control my-form-control  @error('username') is-invalid @enderror" readonly>
                                        @error('username')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
...
@push('admin-js')
    <script>
        ...
        document.getElementById("previewImage").src = "{{isset($user->image)? asset($user->image): asset('noimage.png') }}";
    </script>
